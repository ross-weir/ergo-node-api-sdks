...
class NodeApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.node_shutdown_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/node/shutdown',
                'operation_id': 'node_shutdown',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def node_shutdown(
        ...
        **kwargs
        ...
        >>> thread = api.node_shutdown(async_req=True)
        >>> result = thread.get()
        ...
        return self.node_shutdown_endpoint.call_with_http_info(**kwargs)
