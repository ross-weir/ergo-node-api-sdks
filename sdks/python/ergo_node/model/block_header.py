...
class BlockHeader(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, timestamp, version, ad_proofs_root, state_root, transactions_root, n_bits, extension_hash, pow_solutions, height, difficulty, parent_id, votes, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, timestamp, version, ad_proofs_root, state_root, transactions_root, n_bits, extension_hash, pow_solutions, height, difficulty, parent_id, votes, *args, **kwargs):  # noqa: E501
        """BlockHeader - a model defined in OpenAPI
