...
class SecretProven(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, hint, challenge, pubkey, proof, position, *args, **kwargs):  # noqa: E501
        """SecretProven - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, hint, challenge, pubkey, proof, position, *args, **kwargs):  # noqa: E501
        """SecretProven - a model defined in OpenAPI
