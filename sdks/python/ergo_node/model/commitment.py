...
class Commitment(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, hint, pubkey, position, a, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            b (str): b group element of the commitment (needed for DHT protocol only). [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, hint, pubkey, position, a, *args, **kwargs):  # noqa: E501
        """Commitment - a model defined in OpenAPI
