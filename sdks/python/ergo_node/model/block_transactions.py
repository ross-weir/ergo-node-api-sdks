...
class BlockTransactions(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, header_id, transactions, size, *args, **kwargs):  # noqa: E501
        """BlockTransactions - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, header_id, transactions, size, *args, **kwargs):  # noqa: E501
        """BlockTransactions - a model defined in OpenAPI
