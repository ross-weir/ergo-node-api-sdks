...
class Extension(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'fields': ([KeyValueItem], none_type,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, header_id, digest, fields, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            fields ([KeyValueItem], none_type): List of key-value records
    ...
    @convert_js_args_to_python_args
    def __init__(self, header_id, digest, fields, *args, **kwargs):  # noqa: E501
        """Extension - a model defined in OpenAPI
