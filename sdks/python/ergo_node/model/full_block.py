...
class FullBlock(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'header': (BlockHeader,),  # noqa: E501
            'block_transactions': (BlockTransactions,),  # noqa: E501
            'ad_proofs': (BlockADProofs,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, header, block_transactions, ad_proofs, extension, size, *args, **kwargs):  # noqa: E501
        """FullBlock - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, header, block_transactions, ad_proofs, extension, size, *args, **kwargs):  # noqa: E501
        """FullBlock - a model defined in OpenAPI
