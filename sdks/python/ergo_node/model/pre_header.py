...
class PreHeader(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, timestamp, version, n_bits, height, parent_id, votes, *args, **kwargs):  # noqa: E501
        """PreHeader - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, timestamp, version, n_bits, height, parent_id, votes, *args, **kwargs):  # noqa: E501
        """PreHeader - a model defined in OpenAPI
