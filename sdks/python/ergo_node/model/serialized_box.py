...
class SerializedBox(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, box_id, bytes, *args, **kwargs):  # noqa: E501
        """SerializedBox - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, box_id, bytes, *args, **kwargs):  # noqa: E501
        """SerializedBox - a model defined in OpenAPI
