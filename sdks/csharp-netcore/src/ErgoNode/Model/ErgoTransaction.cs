...
namespace ErgoNode.Model
{
    ...
    /// Ergo transaction
    /// </summary>
    [DataContract(Name = "ErgoTransaction")]
    public partial class ErgoTransaction : IEquatable<ErgoTransaction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErgoTransaction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ErgoTransaction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ErgoTransaction" /> class.
        /// </summary>
        /// <param name="id">Base16-encoded transaction id bytes.</param>
        /// <param name="inputs">Inputs of the transaction (required).</param>
        ...
        public ErgoTransaction(string id = default(string), List<ErgoTransactionInput> inputs = default(List<ErgoTransactionInput>), List<ErgoTransactionDataInput> dataInputs = default(List<ErgoTransactionDataInput>), List<ErgoTransactionOutput> outputs = default(List<ErgoTransactionOutput>), int size = default(int))
        {
            // to ensure "inputs" is required (not null)
            if (inputs == null) {
                throw new ArgumentNullException("inputs is a required property for ErgoTransaction and cannot be null");
            }
            this.Inputs = inputs;
            // to ensure "dataInputs" is required (not null)
            if (dataInputs == null) {
                throw new ArgumentNullException("dataInputs is a required property for ErgoTransaction and cannot be null");
            }
            this.DataInputs = dataInputs;
            // to ensure "outputs" is required (not null)
            if (outputs == null) {
                throw new ArgumentNullException("outputs is a required property for ErgoTransaction and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Inputs of the transaction</value>
        ...
        {
            return this.Equals(input as ErgoTransaction);
        }

        /// <summary>
        /// Returns true if ErgoTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of ErgoTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErgoTransaction input)
        {
            if (input == null)
                return false;
