...
namespace ErgoNode.Model
{
    ...
    public partial class BlockHeader : IEquatable<BlockHeader>, IValidatableObject
    {
        ...
        /// <param name="powSolutions">powSolutions (required).</param>
        ...
        public BlockHeader(string id = default(string), long timestamp = default(long), int version = default(int), string adProofsRoot = default(string), string stateRoot = default(string), string transactionsRoot = default(string), long nBits = default(long), string extensionHash = default(string), PowSolutions powSolutions = default(PowSolutions), int height = default(int), int difficulty = default(int), string parentId = default(string), string votes = default(string), int size = default(int), string extensionId = default(string), string transactionsId = default(string), string adProofsId = default(string))
        {
            ...
            if (adProofsRoot == null) {
                throw new ArgumentNullException("adProofsRoot is a required property for BlockHeader and cannot be null");
            }
            this.AdProofsRoot = adProofsRoot;
            // to ensure "stateRoot" is required (not null)
            if (stateRoot == null) {
                throw new ArgumentNullException("stateRoot is a required property for BlockHeader and cannot be null");
            }
            this.StateRoot = stateRoot;
            // to ensure "transactionsRoot" is required (not null)
            if (transactionsRoot == null) {
                throw new ArgumentNullException("transactionsRoot is a required property for BlockHeader and cannot be null");
            }
            this.TransactionsRoot = transactionsRoot;
            this.NBits = nBits;
            // to ensure "extensionHash" is required (not null)
            if (extensionHash == null) {
                throw new ArgumentNullException("extensionHash is a required property for BlockHeader and cannot be null");
            }
            this.ExtensionHash = extensionHash;
            // to ensure "powSolutions" is required (not null)
            if (powSolutions == null) {
                throw new ArgumentNullException("powSolutions is a required property for BlockHeader and cannot be null");
            }
            ...
            if (parentId == null) {
                throw new ArgumentNullException("parentId is a required property for BlockHeader and cannot be null");
            }
            this.ParentId = parentId;
            // to ensure "votes" is required (not null)
            if (votes == null) {
                throw new ArgumentNullException("votes is a required property for BlockHeader and cannot be null");
            }
            this.Votes = votes;
            this.Size = size;
        ...
        /// </summary>
        [DataMember(Name = "powSolutions", IsRequired = true, EmitDefaultValue = false)]
