...
namespace ErgoNode.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SigmaBoolean")]
    public partial class SigmaBoolean : IEquatable<SigmaBoolean>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SigmaBoolean" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SigmaBoolean() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SigmaBoolean" /> class.
        /// </summary>
        ...
        public SigmaBoolean(int op = default(int), string h = default(string), string g = default(string), string u = default(string), string v = default(string), bool condition = default(bool))
        {
            this.Op = op;
            this.H = h;
            this.G = g;
        ...
        {
            return this.Equals(input as SigmaBoolean);
        }

        /// <summary>
        /// Returns true if SigmaBoolean instances are equal
        /// </summary>
        /// <param name="input">Instance of SigmaBoolean to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SigmaBoolean input)
        {
            if (input == null)
                return false;
