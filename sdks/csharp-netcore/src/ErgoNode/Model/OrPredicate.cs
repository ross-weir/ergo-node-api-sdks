...
namespace ErgoNode.Model
{
    ...
    /// OrPredicate
    /// </summary>
    [DataContract(Name = "OrPredicate")]
    public partial class OrPredicate : IEquatable<OrPredicate>, IValidatableObject
    {
        /// <summary>
        ...
        public OrPredicate(string predicate = default(string), List<ScanningPredicate> args = default(List<ScanningPredicate>))
        {
            // to ensure "predicate" is required (not null)
            if (predicate == null) {
                throw new ArgumentNullException("predicate is a required property for OrPredicate and cannot be null");
            }
        ...
        {
            return this.Equals(input as OrPredicate);
        }

        /// <summary>
        /// Returns true if OrPredicate instances are equal
        /// </summary>
        /// <param name="input">Instance of OrPredicate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrPredicate input)
        {
            if (input == null)
                return false;
