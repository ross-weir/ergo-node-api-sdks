...
namespace ErgoNode.Model
{
    ...
    /// ContainsPredicate
    /// </summary>
    [DataContract(Name = "ContainsPredicate")]
    public partial class ContainsPredicate : IEquatable<ContainsPredicate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContainsPredicate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ContainsPredicate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContainsPredicate" /> class.
        /// </summary>
        ...
        public ContainsPredicate(string predicate = default(string), string register = default(string), string bytes = default(string))
        {
            // to ensure "predicate" is required (not null)
            if (predicate == null) {
                throw new ArgumentNullException("predicate is a required property for ContainsPredicate and cannot be null");
            }
        ...
        {
            return this.Equals(input as ContainsPredicate);
        }

        /// <summary>
        /// Returns true if ContainsPredicate instances are equal
        /// </summary>
        /// <param name="input">Instance of ContainsPredicate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContainsPredicate input)
        {
            if (input == null)
                return false;
