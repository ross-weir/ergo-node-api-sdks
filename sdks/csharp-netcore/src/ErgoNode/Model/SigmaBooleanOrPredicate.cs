...
namespace ErgoNode.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SigmaBooleanOrPredicate")]
    public partial class SigmaBooleanOrPredicate : IEquatable<SigmaBooleanOrPredicate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SigmaBooleanOrPredicate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SigmaBooleanOrPredicate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SigmaBooleanOrPredicate" /> class.
        /// </summary>
        ...
        public SigmaBooleanOrPredicate(int op = default(int), string h = default(string), string g = default(string), string u = default(string), string v = default(string), bool condition = default(bool), List<SigmaBoolean> args = default(List<SigmaBoolean>))
        {
            this.Op = op;
            this.H = h;
            this.G = g;
        ...
        {
            return this.Equals(input as SigmaBooleanOrPredicate);
        }

        /// <summary>
        /// Returns true if SigmaBooleanOrPredicate instances are equal
        /// </summary>
        /// <param name="input">Instance of SigmaBooleanOrPredicate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SigmaBooleanOrPredicate input)
        {
            if (input == null)
                return false;
