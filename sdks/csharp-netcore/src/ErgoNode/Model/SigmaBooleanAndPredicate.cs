...
namespace ErgoNode.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SigmaBooleanAndPredicate")]
    public partial class SigmaBooleanAndPredicate : IEquatable<SigmaBooleanAndPredicate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SigmaBooleanAndPredicate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SigmaBooleanAndPredicate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SigmaBooleanAndPredicate" /> class.
        /// </summary>
        ...
        public SigmaBooleanAndPredicate(int op = default(int), string h = default(string), string g = default(string), string u = default(string), string v = default(string), bool condition = default(bool), List<SigmaBoolean> args = default(List<SigmaBoolean>))
        {
            this.Op = op;
            this.H = h;
            this.G = g;
        ...
        {
            return this.Equals(input as SigmaBooleanAndPredicate);
        }

        /// <summary>
        /// Returns true if SigmaBooleanAndPredicate instances are equal
        /// </summary>
        /// <param name="input">Instance of SigmaBooleanAndPredicate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SigmaBooleanAndPredicate input)
        {
            if (input == null)
                return false;
