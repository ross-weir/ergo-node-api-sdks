...
namespace ErgoNode.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Commitment")]
    public partial class Commitment : IEquatable<Commitment>, IValidatableObject
    {
        /// <summary>
        /// Defines Hint
        /// </summary>
        ...
        public Commitment(HintEnum hint = default(HintEnum), SigmaBoolean pubkey = default(SigmaBoolean), string position = default(string), TypeEnum? type = default(TypeEnum?), string a = default(string), string b = default(string))
        {
            this.Hint = hint;
            // to ensure "pubkey" is required (not null)
            if (pubkey == null) {
                throw new ArgumentNullException("pubkey is a required property for Commitment and cannot be null");
            }
            this.Pubkey = pubkey;
            // to ensure "position" is required (not null)
            if (position == null) {
                throw new ArgumentNullException("position is a required property for Commitment and cannot be null");
            }
            this.Position = position;
            // to ensure "a" is required (not null)
            if (a == null) {
                throw new ArgumentNullException("a is a required property for Commitment and cannot be null");
            }
            this.A = a;
            this.Type = type;
            this.B = b;
        ...
        {
            return this.Equals(input as Commitment);
        }

        /// <summary>
        /// Returns true if Commitment instances are equal
        /// </summary>
        /// <param name="input">Instance of Commitment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Commitment input)
        {
            if (input == null)
                return false;
